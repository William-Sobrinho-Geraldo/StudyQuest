...
export function SupplyChests({ chests, busy, onOpen }: SupplyChestsProps) {
  ...
  return (
    ...
    >
      ...
      <p className="mt-1 text-xs text-slate-500">
        Ganhos ao concluir missões. Abra para receber equipamento nível 0.
      </p>
          ...
          return (
            ...
            >
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-indigo-500 disabled:cursor-not-allowed disabled:opacity-40"
              >
