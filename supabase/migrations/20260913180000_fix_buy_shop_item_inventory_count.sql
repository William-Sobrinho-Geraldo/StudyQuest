-- ═══════════════════════════════════════════════════════════════════
-- Correção da contagem de inventário na compra do mercado.
--
-- A versão anterior contava TODOS os itens de inventory (incluindo os
-- equipados) antes de validar o limite de 24 slots. Com 23 itens na
-- bolsa + 4 equipados, a contagem chegava a 27 e barrava a compra com
-- 'INVENTORY_FULL' mesmo havendo 1 slot livre na bolsa.
--
-- Correção:
--   • A contagem agora considera apenas itens da bolsa (equipped = false),
--     então o limite de 24 slots se refere somente aos itens guardados.
--   • A trava continua sendo `>= 24`, permitindo comprar o 24º item
--     (23 -> 24) e barrando quando a bolsa já estiver cheia.
-- ═══════════════════════════════════════════════════════════════════
